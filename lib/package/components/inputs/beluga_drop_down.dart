...
class BelugaDropDown extends StatefulWidget {
  ...
  final bool useCountryCodePicker;
  ...
  @override
  State<BelugaDropDown> createState() => _BelugaDropDownState();
}

class _BelugaDropDownState extends State<BelugaDropDown> {
  ...
  Widget _buildPrefixWidget() {
    if (!widget.isPrefix) return const SizedBox.shrink();

    if (widget.isButtonPrefix) {
      if (widget.useCountryCodePicker) {
        return Row(
      ...
      return Icon(
        ...
        color: widget.isEnabled! ? AppColors.purple400 : AppColors.gray400,
      );
    }
  }
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.symmetric(
                horizontal: widget.useCountryCodePicker ? 0 : 16.w,
                vertical: 6.h,
              ),
              filled: true,
